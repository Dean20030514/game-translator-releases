...
REM see CLAUDE.md hard contract #12). Pre-r64 START.bat only checked existence; users with
...
if errorlevel 1 (
    ...
    python --version
    echo         See CLAUDE.md hard contract #12 (Python 3.10 floor) — PEP 604 union syntax requires 3.10+.
    pause
    exit /b 1
)
